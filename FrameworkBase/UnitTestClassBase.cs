...
namespace MyNamespace
{
    ...
    public abstract class UnitTestClassBase : UnitTestBase
    {
        ...
        //Creating Object of all Functional Library Classes to get access from Test Classes
    
        public PageOneFunction PageOneController()
        {
            return new PageOneFunction();
        }

        public PageTwoFunction PageTwoController()
        {
            return new PageTwoFunction();
        }

        public PageThreeFunction PageThreeController()
        {
            return new PageThreeFunction();
        }
    }
}
